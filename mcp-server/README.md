...
## Known limits
- **Keyword search only.** Fine at 19 skills; revisit (embeddings, hybrid ranking) only if the catalog grows enough that keyword-in-description misses matches people expect.
