...
| **Capability** | — | The Level 1 pitch-level label for what a skill does, used in `architecture.md`'s diagram and `AGENTS.md`'s Repo Layout table | "Atomic Skill" (renamed in AIPB-03 — too implementation-flavored for a non-technical audience) |
